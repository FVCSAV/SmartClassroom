...
import com.deng.ggkt.order.service.WXPayService;
import com.deng.ggkt.utils.HttpClientUtils;
...
public class WXPayServiceImpl implements WXPayService {
    ...
    public Map<String, Object> createJsapi(String orderNo) {
        ...
        paramMap.put("notify_url", "http://glkt.deng.cn/api/order/wxPay/notify");
